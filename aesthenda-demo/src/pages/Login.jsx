  ...
  return (
    <div className="bg-white border-[16px] border-[#A9A29A] w-full max-w-lg mx-auto">
      ...
      <div className="text-center py-8">
        <h1 className="font-serif text-xl uppercase tracking-widest">Welcome</h1>
        <h2 className="font-serif text-xl uppercase tracking-widest">Back</h2>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="hello@aestheticsalon.com"
              required
              className="w-full border border-gray-300 px-3 py-2 text-sm"
            />
          </div>
          ...
          <div>
            <label htmlFor="password" className="block text-xs uppercase font-medium text-gray-700 mb-1">Password</label>
            <input
              id="password"
              type="password"
              value={password}
